from .v1.hosts import HostsApi, HostDetailsApi, HostHistoryApi, IsROSConfiguredApi, ExecReportDummyAPI
...
def initialize_routes(api):
    ...
    api.add_resource(ExecReportDummyAPI, '/api/ros/v1/dummy_executive_report')
